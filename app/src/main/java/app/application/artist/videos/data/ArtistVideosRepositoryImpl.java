...
/**
 * Implementation of {@link ArtistVideosRepository}
 */
public class ArtistVideosRepositoryImpl implements ArtistVideosRepository {

    /**
     * Loads mock data from assets containing an artists videos (Currently not artist
     * specific).
     *
